...
const ipv6_1 = __importDefault(require("../lib/ipv6"));
const ipv4_1 = __importDefault(require("../lib/ipv4"));
const v4 = new ipv4_1.default();
const queryInMemoey = new ipv6_1.default();
...
describe("Parse Tests", function () {
    ...
    it("parse city ", function () {
        const ret = queryInMemoey.parseResult({ cArea: "中国湖北省恩施土家族苗族自治州恩施市", aArea: "" });
        expect(ret).toMatchObject({
            isp: "",
...
//# sourceMappingURL=test_ipv6.js.map